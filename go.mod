...
require (
	buf.build/gen/go/cirruslabs/tart-guest-agent/grpc/go v1.6.2-20260512202756-8fe99381af1e.1
	buf.build/gen/go/cirruslabs/tart-guest-agent/protocolbuffers/go v1.36.11-20260512202756-8fe99381af1e.1
